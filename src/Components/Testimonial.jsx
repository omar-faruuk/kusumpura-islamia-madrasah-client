    ...
    return (
        <div className="container mt-5 mb-5">
            ...
            <div className="row g-5">
                {
                    testimonial.map(testi => <div key={testi.id} className='col-md-4'>
                        <Card className="card">
                            <Image src={testi.img} className="card-img-top" alt="..." />
                            <div className="card-body">
                                <h5 className="card-title text-center">{testi.name}</h5>
                                <p className='text-center mb-0'>{testi.position}</p>
                                <h6 className='text-center'>{testi.title}</h6>
                                <p className='text-muted text-center'>{testi.subTitle}</p>
                                <P className="card-text">{testi.speach}</P>
